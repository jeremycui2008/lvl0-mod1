...
def mouse_pressed(event):
    ...
    # of a triangle
    canvas.create_oval(x-40, y-10+100, x+40, y+78+100, fill='yellow')
    canvas.create_oval(x-40, y-30+100, x+40, y+60+100, fill='orange')
    canvas.create_oval(x-40, y-50+100, x+40, y+37+100, fill='red')
